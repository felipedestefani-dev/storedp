...
1. No início de `app.js` (e no script de `auth-callback.html`), preencha `SUPABASE_URL` e `SUPABASE_ANON_KEY`.
...
Sem URL/chave válidas no `app.js`, o site mostra a tela de configuração.
